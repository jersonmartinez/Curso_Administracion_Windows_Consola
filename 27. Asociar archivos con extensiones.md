...
### ASSOC
Comando para ver y modificar asociaciones de archivos.
...
- `.ext` - Extensión de archivo (ej: .txt)
- `fileType` - Tipo de archivo asociado
- Sin parámetros - Muestra todas las asociaciones

### FTYPE
Define comandos para tipos de archivo específicos.
...
### REG
Manipulación directa del registro de Windows.
