...
PowerShell proporciona comandos modernos y flexibles para expandir archivos comprimidos.
...
El comando `COMPACT` también puede descomprimir archivos nativos de Windows.
...
Windows 10 y posteriores incluyen soporte nativo para archivos TAR.
