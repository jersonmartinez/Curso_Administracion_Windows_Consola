...
### SORT
El comando `SORT` es la herramienta fundamental para ordenar datos de texto.
...
- `/M kilobytes` - Memoria máxima para ordenar
- `/L locale` - Configuración regional específica
- `/REC recordbytes` - Tamaño máximo de registro

### FOR con ordenamiento
Combinación poderosa para procesar archivos ordenados.

### DIR con ordenamiento
Visualizar directorios de manera organizada.
